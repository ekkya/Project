...
class BallAndStick:
    def __init__(self,cell,morph,bio,temp):
        self.c = cell
        self.m = morph
        self.b = bio
        self.t = temp
        neuron.h.__init__(self, c=cell, m=morph, b=bio, t=temp)

def create_cell():
    """Create the cell model"""
    # Load morphology
    morph1 = neuron.h.load_file("morphology.hoc")
    bio1 = neuron.h.load_file("biophysics.hoc")
    temp1 = neuron.h.load_file("template.hoc")

    # Instantiate the cell from the template
    print("Loading cell cACint209_L5_DBC_6a2bbf2a1b")
    cell1 = "cACint209_L5_DBC_6a2bbf2a1b"
    newcell = BallAndStick(cell1, morph1, bio1, temp1)
    return newcell
